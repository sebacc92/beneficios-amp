        ...
        {sortedList.map((off) => {
          ...
          return (
            <Link
              ...
              href={href}
              class={[
                "flex items-center justify-between space-x-2 px-3.5 py-1.5 rounded-full border transition-all duration-300 flex-shrink-0 select-none cursor-pointer group snap-start shadow-sm text-[11px] font-black uppercase tracking-wider",
                isSelected
            ...
            >
              ...
              <span
                class={[
                  "flex items-center justify-center text-[9px] font-black px-1.5 py-0.5 rounded-full min-w-[16px] h-4.5 leading-none transition-all duration-300",
                  isSelected
