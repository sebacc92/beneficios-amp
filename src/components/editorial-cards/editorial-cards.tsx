            ...
            {user.value ? (
              <div class="w-full space-y-6">
                <div class="w-full h-52 bg-gradient-to-br from-brand-green-dark to-brand-green text-white rounded-2xl p-6 relative shadow-lg overflow-hidden flex flex-col justify-between text-left border border-emerald-400/25">
                  ...
                  <div><span class="text-[8.5px] font-black text-emerald-300 uppercase tracking-widest leading-none">Médico Agremiado</span><h4 class="text-lg font-display font-extrabold tracking-wide truncate mt-0.5">Socio AMP+</h4><span class="text-[11px] font-mono bg-slate-900/30 px-2 py-0.5 rounded text-emerald-100 mt-1.5 inline-block">M.P. ●●●●●</span></div>
                ...
                <div class="flex flex-col items-center justify-center p-6 bg-slate-50 border border-slate-100 rounded-2xl space-y-4">
                  ...
                  <div class="text-center space-y-1"><span class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Código Dinámico de Validación</span><p class="text-sm font-mono font-bold text-slate-700">AMP-●●●●●-●●●●●●</p><p class="text-[11px] text-slate-400 font-medium">Presentá este código o QR en caja para recibir tu beneficio.</p></div>
                </div>
              </div>
            ) : (
